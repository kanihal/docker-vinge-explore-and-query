...
function staticSuggestionsCls() {
	...
	staticSuggestionsCls();
	CodeMirror.sparHints[' '] = window.standardTokens.split("|").sort();
//////////////////////////////////////////////////////////////////////////
// init codemirror obj
//////////////////////////////////////////////////////////////////////////
	var editor_cls = CodeMirror.fromTextArea(document.getElementById("code_cls"), {
...
//////////////////////////////////////////////////////////////////////////
function dynamicClsSuggestionsCTRLSpace(cm, url) {
...
CodeMirror.commands.autocomplete = function(cm) {
	...
	window.ctrlSPace='1';
	dynamicClsSuggestionsCTRLSpace(cm,url);
	options['what']='ctrl';

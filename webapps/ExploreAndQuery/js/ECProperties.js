...
$(document).ready(function (){
	...
	$('.CodeMirror').attr('style', $('.CodeMirror').attr('style') + '; ' + 'height: 26px !important');
});
////////////////////////////////////////////////////////////////////////
// Preloaded Query
...
////////////////////////////////////////////////////////////////////////
function staticSuggestionsProps() {
	var xmlhttp; var k= Math.random(); var url=location.pathname;

	url=url + "/../sparql/properties?"+k;
	...
	staticSuggestionsProps();
	CodeMirror.sparHints[' '] = window.standardTokens.split("|").sort();
//////////////////////////////////////////////////////////////////////////
// init codemirror obj
//////////////////////////////////////////////////////////////////////////
	var editor_prop = CodeMirror.fromTextArea(document.getElementById("code_prop"), {
...
//////////////////////////////////////////////////////////////////////////
function dynamicPropSuggestionsCTRLSpace(cm, url) {
	var xmlhttp; var args=prepareUrl(cm);
	var url=url + "/../getSuggestionList?trigger=ctrl"+args+ "&type=" + cm.getTextArea().name;
...
CodeMirror.commands.autocomplete = function(cm) {
	...
	window.ctrlSPace='1';
	dynamicPropSuggestionsCTRLSpace(cm,url);
	options['what']='ctrl';
...
function passAndHintAllKeys(cm) {
	...
	// disable autocomplete in the text field. User must first get the list with CTRL-SPACE and then kan type 
	return false;
